...
class Player_Window(QtWidgets.QMainWindow):        
    ...
    def setupUi(self):
        ...
        self.label_player_age = QtWidgets.QLabel(self.centralwidget)
        ...
        self.label_player_height = QtWidgets.QLabel(self.centralwidget)
        ...
        self.label_player_weight = QtWidgets.QLabel(self.centralwidget)
        ...
        self.label_player_shoots = QtWidgets.QLabel(self.centralwidget)
        ...
        self.label_player_birthplace = QtWidgets.QLabel(self.centralwidget)
