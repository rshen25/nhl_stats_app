...
class Boxscore_Window(QtWidgets.QMainWindow):
    ...
    def setupUi(self):
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(190, 0, 471, 51))
        self.horizontalLayoutWidget.setObjectName("horizontalLayoutWidget")
        self.layout_home_team_stats = QtWidgets.QHBoxLayout(self.horizontalLayoutWidget)
        self.layout_home_team_stats.setContentsMargins(0, 0, 0, 0)
        self.layout_home_team_stats.setObjectName("layout_home_team_stats")
        self.horizontalLayoutWidget_2 = QtWidgets.QWidget(self.centralwidget)
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(190, 380, 471, 51))
        self.horizontalLayoutWidget_2.setObjectName("horizontalLayoutWidget_2")
        self.layout_away_team_stats = QtWidgets.QHBoxLayout(self.horizontalLayoutWidget_2)
        self.layout_away_team_stats.setContentsMargins(0, 0, 0, 0)
